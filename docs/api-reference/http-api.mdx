...
Generate a PDF report with stats chart and filtered results table.
...
<Note>
Requires `weasyprint` and system dependencies (Pango, Cairo). Install with `pip install ezvals[pdf]`.
</Note>
