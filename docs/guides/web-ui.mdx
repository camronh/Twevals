...
Click the download icon in the header to open the export menu with four formats:

| Format | Type | Description |
|--------|------|-------------|
| JSON | Raw | Full results file as-is |
| CSV | Raw | All results in flat CSV format |
| PDF | Filtered | Stats chart + table with current filters applied |
...
The PDF includes an SVG bar chart showing pass rates for each score metric. Markdown uses ASCII progress bars with color indicators:
